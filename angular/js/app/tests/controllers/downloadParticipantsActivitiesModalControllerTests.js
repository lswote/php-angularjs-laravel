describe('downloadParticipantsActivitiesModalController Test Suite', function(){
    ...
    beforeEach(inject(function($controller, $rootScope, $injector, $window, $q){
        ...
        $controller('downloadParticipantsActivitiesModalController', {
            $scope: scope
        });
    }));

    describe('downloadParticipantsActivities Test', function(){
		it('should set scope.callInProgress to its correct value and call window.open() and rootScope.toggleModal()', function(){
			...
			scope.downloadParticipantsActivities();
